...
const COUNTRY_ISO = {
  ...
  'BAHAMAS': 'bs', 'BAHREIN': 'bh', 'BARBADE': 'bb', 'BELGIQUE': 'be', 'BERMUDES': 'bm', 'BIELORUSSIE': 'by',
  'BOLIVIE': 'bo', 'BOSNIE': 'ba', 'BOTSWANA': 'bw', 'BRESIL': 'br', 'BULGARIE': 'bg',
  ...
  'GEORGIE': 'ge', 'GRANDE BRETAGNE': 'gb', 'GRECE': 'gr', 'HOLLANDE': 'nl', 'HONG KONG': 'hk',
  ...
  'LUXEMBOURG': 'lu', 'MACEDOINE': 'mk', 'MALAISIE': 'my', 'MALTE': 'mt', 'MAROC': 'ma', 'MEXIQUE': 'mx',
  'MOLDAVIE': 'md', 'MONACO': 'mc', 'NEPAL': 'np', 'NEW ZELAND': 'nz', 'NIGERIA': 'ng', 'NORVEGE': 'no',
  'OUZBEKISTAN': 'uz', 'PAKISTAN': 'pk', 'PARAGUAY': 'py', 'PEROU': 'pe',
  'POLOGNE': 'pl', 'PORTUGAL': 'pt', 'QATAR': 'qa', 'RD CONGO': 'cd', 'REPUBLIQUE DOMINICAINE': 'do', 'ROUMANIE': 'ro',
