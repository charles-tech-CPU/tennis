...
public class EntryService {
    ...
    public EntryDto create(Long tournamentId, EntryCreateDto dto) {
        ...
        if (!dto.bye()) {
            ...
            if (!entryRepository
                    .findByTournamentIdAndPlayerId(tournamentId, dto.playerId())
                    .isEmpty()) {
                throw new IllegalArgumentException(player.getLastName() + " est deja inscrit dans ce tableau.");
            }
    ...
    private void checkSameWeekConflict(Tournament tournament, Player player) {
        ...
        Long siblingId = tournament.isQualifying()
                ...
                : tournamentRepository
                        .findByMainTournamentId(tournament.getId())
